...
[uninstalled] [4.0.10 ] wrapper           standard-4.0.10      Provide OS integration
[uninstalled] [4.0.10 ] obr               standard-4.0.10      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.0.10 ] config            standard-4.0.10      Provide OSGi ConfigAdmin support
[uninstalled] [4.0.10 ] region            standard-4.0.10      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.0.10      Provide Jetty engine support
[uninstalled] [4.0.10 ] http              standard-4.0.10      Implementation of the OSGI HTTP Service
[uninstalled] [4.0.10 ] http-whiteboard   standard-4.0.10      Provide HTTP Whiteboard pattern support
[uninstalled] [4.0.10 ] war               standard-4.0.10      Turn Karaf as a full WebContainer
[uninstalled] [4.0.10 ] deployers         standard-4.0.10      Provide Karaf deployer
[uninstalled] [4.0.10 ] kar               standard-4.0.10      Provide KAR (KARaf archive) support
[uninstalled] [4.0.10 ] webconsole-base   standard-4.0.10      Base support of the Karaf WebConsole
[uninstalled] [4.0.10 ] webconsole        standard-4.0.10      Karaf WebConsole for administration and monitoring
[uninstalled] [4.0.10 ] ssh               standard-4.0.10      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.0.10.war, and
